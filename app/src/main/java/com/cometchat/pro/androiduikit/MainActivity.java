...
public class MainActivity extends AppCompatActivity {
    ...
    private AppCompatImageView ivLogoIchat;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        superhero3 = findViewById(R.id.superhero1); //superhero3
        superhero4 = findViewById(R.id.superhero2);//superhero4
        ivLogoIchat = findViewById(R.id.ivLogoIchat);
...
//            ivLogoIchat.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.textColorWhite)));
//        }
//        else {
//            ivLogoIchat.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.primaryTextColor)));
//        }
    }
